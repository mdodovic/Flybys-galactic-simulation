...
frun="C:/Users/matij/Desktop/Projekat_2017-Flybays/snapovi/"  
...
for num =60,60 do begin

 ;   exts='000'
 ;   exts=exts+strcompress(string(num),/remove_all)
 ;   exts=strmid(exts,strlen(exts)-3,3)

    fname=frun+"snapshot_000";+exts 
   ...
   ;na originalni show_galaxy.pro dopisan je samo ovaj deo za plotovanje 
    
    !P.MULTI=[0,2,0]
    collist=[255*256L*256L+100*256L+100, 255*256L, 255L, 255*256L+255L, 255*256L*256L+255L]

    plot, xdisk, ydisk, psym=3, xrange= [-xlen, xlen], yrange= [-xlen,xlen], xstyle=1,ystyle=1,  color=collist(3 mod n_elements(collist))
   ...
   ;na originalni show_galaxy.pro dopisan je samo ovaj deo za plotovanje 
    ...
    oplot, xhalo, yhalo, psym=3,   color=collist(10 mod n_elements(collist))
